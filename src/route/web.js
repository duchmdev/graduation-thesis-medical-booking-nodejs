...
let initWebRoutes = (app) => {
  ...
  router.post("/api/send-sheet", doctorController.sendSheet);
  router.post("/api/send-invoice", doctorController.sendInvoice);
  router.post("/api/create-remedy", doctorController.createRemedy);
  router.post("/api/create-sheet-medical-examination-result", doctorController.createSheetMedicalExaminationResult);
  router.post("/api/create-invoice", doctorController.createInvoice);
  ...
  //pdf
  router.get("/api/view-pdf", doctorController.viewPdf);
  router.get("/api/download-pdf", doctorController.downloadPdf);

  //bookings
  router.post(
    "/api/filter-history-bookings",
    patientController.filterHistoryBookings
  );
  router.post(
    "/api/filter-bookings-by-date-timestamp",
    patientController.filterBookingsByDateTimestamp
  );
  router.post(
    "/api/filter-bookings",
    patientController.filterBookings
  );
  router.post("/api/update-status-booking", patientController.updateStatusBooking);
